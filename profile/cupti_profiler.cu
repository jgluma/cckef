...
static unsigned long long max_idx;
...
void
CuptiProfiler::start_kernelduration_cupti_profiler()
{
...
void
CuptiProfiler::advance_cupti_profiler( CUpti_EventGroupSets *passData, int pass )
{
	m_metricData.eventGroups = passData->sets + pass;
}

void
CuptiProfiler::stop_cupti_profiler( bool getvalue )
{
...
void
CuptiProfiler::free_cupti_profiler() {
...
void
CuptiProfiler::close_metric_file()
{
	fclose(m_fp);
}
